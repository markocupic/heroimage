...
$GLOBALS['TL_LANG']['tl_content']['heroImageText'] = array('Text', 'F&uuml;gen Sie einen Text hinzu.');
$GLOBALS['TL_LANG']['tl_content']['addHeroImage'] = array('Hero Hintergrundbild hinzuf&uuml;gen', 'F&uuml;gen Sie ein Hero Hintergrundbild hinzu.');
$GLOBALS['TL_LANG']['tl_content']['heroImageButtonClass'] = array('Button CSS-Klassen', 'Z.B. Bootstrap Klassen: btn btn-primary');
